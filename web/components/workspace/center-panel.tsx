      ...
      <div className="flex h-16 items-center justify-between border-b px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button size="sm" onClick={commitRun} disabled={isRunning} className="gap-1.5">
            <Play className="h-3.5 w-3.5" />{isRunning ? "Running..." : "Run Analysis"}
          </Button>
        </div>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={onTabChange} className="flex flex-1 flex-col min-h-0">
        <div className="border-b px-6">
          <TabsList className="h-10 bg-transparent p-0 gap-6">
            <TabsTrigger value="project" className="h-10 rounded-none border-b-2 border-transparent px-0 text-sm font-medium text-muted-foreground data-[state=active]:border-primary data-[state=active]:text-foreground data-[state=active]:shadow-none bg-transparent">
              Project
            </TabsTrigger>
            <TabsTrigger value="insights" className="h-10 rounded-none border-b-2 border-transparent px-0 text-sm font-medium text-muted-foreground data-[state=active]:border-primary data-[state=active]:text-foreground data-[state=active]:shadow-none bg-transparent">
              Insights{hasBaseline && <span className="ml-1.5 h-1.5 w-1.5 rounded-full bg-primary inline-block align-middle" />}
            </TabsTrigger>
          </TabsList>
        </div>
